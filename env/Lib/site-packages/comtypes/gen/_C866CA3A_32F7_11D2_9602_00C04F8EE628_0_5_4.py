...
__all__ = [
    'SGRSTTWildcard', 'SpeechGrammarWordType', 'DISPID_SVSPhonemeId',
    'SpeechRecoContextState', 'DISPID_SRCRequestedUIType',
    'DISPID_SGRsAdd', 'DISPID_SABufferNotifySize',
    'SPFM_OPEN_READWRITE', 'SAFTTrueSpeech_8kHz1BitMono',
    'SpeechGrammarRuleStateTransitionType', 'eLEXTYPE_PRIVATE18',
    'SVSFPurgeBeforeSpeak', 'DISPID_SVPause', 'SP_VISEME_5',
    'DISPID_SRCPause', 'DISPID_SPEPronunciation',
    'DISPID_SGRInitialState', 'SPXMLRESULTOPTIONS', 'SVP_11',
    'ISequentialStream', 'SPEI_SOUND_START', 'SPINTERFERENCE_NONE',
    'eLEXTYPE_PRIVATE20', 'DISPID_SPPFirstElement',
    'DISPID_SRCESoundStart', 'DISPID_SDKEnumValues',
    'ISpXMLRecoResult', 'DISPID_SRCERecognizerStateChange', 'SVP_2',
    'DISPID_SRCEInterference', 'SRAImport', 'DISPID_SOTId', 'SVP_19',
    'DISPID_SRGCommit', 'DISPID_SOTsCount', 'STSF_AppData',
    'DISPID_SpeechXMLRecoResult', 'SPSEMANTICERRORINFO',
    'SPPS_Noncontent', 'DISPID_SRGetPropertyString',
    'DISPID_SGRsCount', 'SpeechAudioFormatGUIDWave', 'SASClosed',
    'SPSMF_UPS', 'SpLexicon', 'SITooLoud',
    'DISPID_SRCCmdMaxAlternates', 'SDTRule', 'SAFT32kHz16BitMono',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPIAudioSizeTime',
    'SVEStartInputStream', 'DISPID_SpeechLexicon',
    'DISPID_SPILanguageId', 'DISPID_SPPsItem',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRRTimes',
    'SPCT_SUB_DICTATION', 'SpeechVoiceSpeakFlags', 'SPEI_REQUEST_UI',
    'DISPID_SWFESamplesPerSec', 'DISPID_SVStatus',
    'DISPID_SGRsDynamic', 'SITooSlow', 'eLEXTYPE_RESERVED10',
    'SAFT44kHz8BitStereo', 'DISPID_SpeechPhraseRule',
    'SPEI_END_SR_STREAM', 'DISPID_SPEAudioTimeOffset',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SOTCategory',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRCEventInterests', 'DISPID_SGRSTsCount', 'SVP_1',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SPEDisplayAttributes', 'SSFMCreate', 'SpeechDiscardType',
    'DISPID_SPISaveToMemory', 'DISPID_SPCLangId', 'SPEVENTSOURCEINFO',
    'SpSharedRecognizer', 'DISPID_SpeechPhraseAlternates',
    'SPPS_Modifier', 'SAFT8kHz8BitMono', 'SPVPRIORITY',
    'SDKLCurrentConfig', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRRAlternates', 'SRTSMLTimeout', 'SP_VISEME_8',
    'ISpeechPhraseRule', 'DISPID_SRCERequestUI', 'SPAR_Low',
    'SPRECOGNIZERSTATUS', 'SPAUDIOBUFFERINFO', 'DISPID_SOTsItem',
    'SpeechRecoEvents', 'SpVoice', 'SVPOver', 'SRAExport',
    'DISPID_SGRSTransitions', 'SP_VISEME_9', 'DISPID_SDKDeleteValue',
    'SDA_No_Trailing_Space', 'DISPID_SRState', 'SPPS_NotOverriden',
    'ISpRecoGrammar2', 'DISPID_SVSInputWordPosition',
    'DISPID_SVAlertBoundary', 'DISPID_SpeechPhraseAlternate',
    'SAFTCCITT_ALaw_11kHzMono', 'SpNotifyTranslator', 'SVP_21',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPLOADOPTIONS',
    'SpeechCategoryRecognizers', 'SpeechRecoProfileProperties',
    'SVSFIsFilename', 'SP_VISEME_15', 'SVSFIsNotXML', 'SPAR_Unknown',
    'DISPID_SRGRecoContext', 'SPWF_INPUT', 'DISPID_SVEWord',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SVEEnginePrivate', 'SVP_6',
    'SP_VISEME_18', 'SVP_12', 'SPEI_SR_BOOKMARK', 'SRTReSent',
    'SPSFunction', 'SDTProperty', 'SPCT_DICTATION', 'SPPARTOFSPEECH',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SLWWord',
    'SPGRAMMARWORDTYPE', 'SpeechLexiconType', 'SPCATEGORYTYPE',
    'DISPID_SRCEAudioLevel', 'DISPID_SPRText', 'DISPID_SGRSTWeight',
    'DISPID_SBSRead', 'SVESentenceBoundary',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPCIdToPhone',
    'SREAllEvents', 'SP_VISEME_19', 'eLEXTYPE_RESERVED6',
    'SpeechEngineProperties', 'SAFT32kHz8BitMono', 'SECFIgnoreCase',
    'ISpResourceManager', 'DISPID_SRCEEnginePrivate',
    'DISPID_SVGetProfiles', 'DISPID_SPEAudioStreamOffset',
    'SAFTDefault', 'DISPID_SPPConfidence', 'DISPID_SVSRunningState',
    'SpMMAudioOut', 'DISPID_SRGIsPronounceable', 'IStream',
    'SREStateChange', 'SREStreamStart', 'DISPID_SRRSpeakAudio',
    'SPWORDPRONUNCIATIONLIST', 'SRARoot', 'SVSFIsXML',
    'SPINTERFERENCE_TOOLOUD', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SpeechAudioStatus', 'SP_VISEME_21', 'SPWT_LEXICAL',
    'SGDSActiveUserDelimited', 'SPSHT_Unknown',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SABIMinNotification',
    'SPADAPTATIONRELEVANCE', 'DISPID_SPEsCount', 'tagSTATSTG',
    'DISPID_SPRuleChildren', 'SAFT44kHz16BitMono',
    'DISPID_SVSLastBookmarkId', 'SP_VISEME_7', 'SPRST_NUM_STATES',
    ...
    'SAFTADPCM_11kHzStereo', 'DISPID_SASCurrentDevicePosition',
    'SpeechDictationTopicSpelling', 'SAFT12kHz16BitMono',
    'SVSFUnusedFlags', 'DISPID_SABIEventBias', '_RemotableHandle',
    'SpInProcRecoContext', 'SLODynamic', 'SPEI_END_INPUT_STREAM',
    'DISPID_SPPs_NewEnum', 'SPPS_RESERVED4',
    'DISPID_SRCEFalseRecognition', 'SVSFParseSapi', 'SVP_10',
    'DISPID_SRGId', 'DISPID_SRGReset', 'DISPID_SRRTOffsetFromStart',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SGRSTs_NewEnum',
    'SSTTTextBuffer', 'DISPID_SVEStreamStart', 'SAFT32kHz16BitStereo',
    'SPXRO_SML', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SWFEFormatTag', 'ISpeechPhraseInfo', 'ISpGrammarBuilder',
    'SPGS_ENABLED', 'ISpeechPhraseProperty', 'SAFT8kHz16BitStereo',
    'UINT_PTR', 'SVSFParseSsml', 'DISPID_SBSSeek',
    'ISpeechPhraseAlternate', 'SPCT_SLEEP',
    'DISPID_SPEEngineConfidence', 'DISPID_SPIGetText', 'SP_VISEME_13',
    'SpeechVoiceEvents', 'SBOPause', 'SPGS_DISABLED',
    'DISPID_SCSBaseStream', 'SP_VISEME_3', 'DISPID_SPIRule',
    'DISPID_SLPSymbolic', 'SVEAudioLevel',
    'DISPID_SpeechRecognizerStatus', 'SPEI_RESERVED5',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPIRetainedSizeBytes',
    'SP_VISEME_1', 'DISPID_SGRsFindRule', 'ISpRecoContext2',
    'SpeechAudioProperties', 'SAFT11kHz8BitStereo',
    'ISpeechRecognizer', 'DISPID_SRCSetAdaptationData',
    'DISPID_SVEPhoneme', 'DISPID_SpeechLexiconProns',
    'DISPID_SGRAttributes', '_ISpeechRecoContextEvents',
    'SPPHRASEREPLACEMENT', 'tagSPTEXTSELECTIONINFO', 'DISPID_SFSOpen',
    'ISpeechAudioBufferInfo', 'DISPID_SVWaitUntilDone',
    'DISPID_SPRuleNumberOfElements', 'ISpEventSource',
    'SECFEmulateResult', 'SpStream', 'DISPID_SRCCreateGrammar',
    'SRAORetainAudio', 'SPFM_CREATE_ALWAYS',
    'DISPID_SPRDisplayAttributes', 'SPEI_MAX_SR',
    ...
    'ISpeechWaveFormatEx', 'DISPID_SOTIsUISupported', 'SREBookmark',
    'ISpeechGrammarRuleStateTransition', 'eLEXTYPE_PRIVATE11',
    ...
    'DISPID_SRCESoundEnd', 'SpeechCategoryAudioOut',
    'SPEI_RECO_OTHER_CONTEXT', 'SPAS_STOP', 'SPLEXICONTYPE',
    'SGDSInactive', 'SpMMAudioIn', 'IEnumSpObjectTokens',
    'SRTEmulated', 'SAFT16kHz8BitStereo', 'DISPID_SVSLastResult',
    'ISpeechAudioFormat', 'SRCS_Enabled', 'SPEI_ADAPTATION',
    'DISPID_SpeechPhraseElements', 'ISpObjectTokenCategory',
    'SpeechCategoryAudioIn', 'DISPID_SOTCDefault',
    'DISPID_SpeechMemoryStream', 'ISpRecoCategory',
    'DISPID_SLRemovePronunciation', 'DISPID_SLPLangId', 'SAFTText',
    'SpeechFormatType', 'SLTUser', 'DISPID_SOTCSetId',
    'SPDKL_DefaultLocation', 'DISPID_SPPName',
    'DISPID_SRIsUISupported', 'SPEI_RECOGNITION', 'SFTSREngine',
    'SRAInterpreter', 'SPCS_ENABLED', 'SPPROPERTYINFO',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SSSPTRelativeToStart',
    'SPEI_START_SR_STREAM', 'SpeechTokenValueCLSID',
    'DISPID_SDKDeleteKey', 'SRTAutopause', 'SPWT_PRONUNCIATION',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SVSkip', 'SpWaveFormatEx',
    'SpeechDataKeyLocation', 'ISpeechVoice',
    'SPSMF_SRGS_SAPIPROPERTIES', 'ISpRecoContext', 'DISPID_SRCVoice',
    'DISPID_SOTRemove', 'DISPID_SOTs_NewEnum', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SpeechLexiconWord', 'SPVPRI_ALERT', 'ISpeechObjectTokens',
    'ISpPhrase', 'DISPID_SGRSTType', 'DISPID_SPRuleFirstElement',
    'SpeechTokenIdUserLexicon', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SRDisplayUI', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPIEnginePrivateData', 'eWORDTYPE_DELETED',
    'SGLexicalNoSpecialChars', 'SPPHRASE', 'SDTAudio', 'ISpShortcut',
    'SAFT16kHz8BitMono', 'DISPID_SVPriority', 'SGRSTTEpsilon',
    'SAFT11kHz8BitMono', 'SPAS_CLOSED', 'STSF_FlagCreate',
    'DISPID_SVSInputSentencePosition', 'DISPID_SpeechVoice',
    'DISPID_SVResume', 'DISPID_SRCEBookmark', 'SpPhoneConverter',
    'SPSHT_EMAIL', 'SPWF_SRENGINE', 'SpeechEngineConfidence',
    'SRCS_Disabled', 'SP_VISEME_11', 'SPEVENT',
    'DISPIDSPTSI_SelectionLength', 'SVEEndInputStream',
    'DISPID_SADefaultFormat', 'DISPID_SRProfile',
    'SAFT44kHz16BitStereo', 'DISPID_SWFEBlockAlign',
    'SpeechVoiceCategoryTTSRate', 'SVF_Emphasis', 'SpeechLoadOption',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SRCEEndStream',
    'ISpeechPhraseReplacements', 'SpeechStreamFileMode',
    'DISPID_SRRTLength', 'IInternetSecurityManager',
    'ISpeechXMLRecoResult', 'ISpSerializeState', 'SINone',
    'SVF_Stressed', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRAudioInputStream', 'SpeechTokenKeyUI',
    'SAFT24kHz16BitStereo', 'DISPID_SVIsUISupported',
    'DISPID_SOTDisplayUI', 'DISPID_SOTCId', 'ISpeechRecognizerStatus',
    'SPEI_TTS_BOOKMARK', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SpeechPhoneConverter', 'DISPID_SVEViseme',
    'DISPID_SRGetFormat', 'SVSFNLPSpeakPunc', 'SP_VISEME_20',
    'DISPID_SPEs_NewEnum', 'SpeechRuleState',
    'DISPID_SLGetGenerationChange', 'SPPS_LMA', 'SRSActiveAlways',
    'SAFTCCITT_ALaw_44kHzStereo', 'SpeechCategoryPhoneConverters',
    'SP_VISEME_0', 'SPSEMANTICFORMAT', 'SRESoundEnd',
    'DISPIDSPTSI_ActiveOffset', 'SPTEXTSELECTIONINFO',
    'DISPID_SPRuleId', 'DISPID_SGRSTPropertyValue',
    'SAFTGSM610_11kHzMono', 'SAFT12kHz8BitMono',
    'SRSInactiveWithPurge', 'SpeechBookmarkOptions',
    'ISpeechBaseStream', 'SPAUDIOSTATE', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SRCRetainedAudio',
    'SECNormalConfidence', 'SpeechRecognizerState',
    'SpeechMicTraining', 'SPEI_TTS_AUDIO_LEVEL', 'SGRSTTDictation',
    'DISPID_SRSClsidEngine', 'DISPID_SGRsCommitAndSave',
    'DISPID_SRGDictationUnload', 'SVSFDefault',
    'SPINTERFERENCE_TOOSLOW', 'ISpeechLexiconWord',
    'SPBOOKMARKOPTIONS', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SMSSetData', 'DISPIDSPRG', 'DISPID_SWFEAvgBytesPerSec',
    'SP_VISEME_2', 'SPAO_RETAIN_AUDIO', 'DISPID_SPAPhraseInfo',
    'SPEI_RESERVED6', 'tagSPPROPERTYINFO', 'DISPID_SDKGetBinaryValue',
    'SPEI_MIN_TTS', 'DISPID_SAFType', 'DISPID_SPARecoResult',
    'SpCompressedLexicon', 'SRADefaultToActive', 'SPPS_Interjection',
    'eLEXTYPE_RESERVED9', 'SDKLDefaultLocation', 'SVP_14',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SPRuleName',
    'DISPID_SVGetAudioOutputs', 'DISPID_SRRSaveToMemory', 'SGDisplay',
    'DISPID_SpeechGrammarRule', 'SpeechVisemeType',
    'SPSERIALIZEDPHRASE', 'SPPS_RESERVED2',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpStream',
    'SPAS_PAUSE', 'SpeechAudioFormatType', 'SPSERIALIZEDRESULT',
    'SDTAll', 'DISPID_SAVolume', 'DISPID_SVRate', 'DISPID_SMSALineId',
    'eLEXTYPE_RESERVED4', 'SRESoundStart', 'DISPID_SVEventInterests',
    'SpeechAudioState', 'SpeechGrammarTagWildcard', 'SPVPRI_OVER',
    'DISPID_SVGetVoices', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SPIStartTime', 'SASStop', 'SAFT11kHz16BitStereo',
    'SVF_None', 'SPEI_WORD_BOUNDARY', 'SPINTERFERENCE_NOSIGNAL',
    'SDKLCurrentUser', 'DISPID_SGRSTPropertyId', 'SGRSTTWord',
    'SPRECOSTATE', 'SAFTGSM610_8kHzMono', 'SpFileStream',
    'SPCT_COMMAND', 'WAVEFORMATEX', 'STCInprocHandler', 'SFTInput',
    'SAFT24kHz16BitMono', 'SGDSActive', 'SPPS_RESERVED3',
    'DISPID_SPACommit', 'DISPID_SOTSetId', 'SVSFParseMask',
    'DISPID_SPRulesCount', 'SpInprocRecognizer',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SAFGuid',
    'ISpeechMemoryStream', 'SPRST_INACTIVE', 'DISPID_SGRSTsItem',
    'SSSPTRelativeToEnd', 'SDTAlternates', 'DISPID_SPEAudioSizeBytes',
    'SpeechRetainedAudioOptions', 'SPEI_TTS_PRIVATE',
    'ISpObjectWithToken', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRCEHypothesis', 'SVSFVoiceMask', 'SpeechTokenKeyFiles',
    'DISPID_SDKEnumKeys', 'DISPID_SVEAudioLevel',
    'SpPhoneticAlphabetConverter', 'SPEI_RECO_STATE_CHANGE',
    'SWTAdded', 'SREAudioLevel',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SWFEChannels',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechLexiconWords',
    'DISPID_SVEBookmark', 'SP_VISEME_10', 'DISPID_SRRGetXMLResult',
    'ISpeechGrammarRule', 'SRERecoOtherContext', 'ISpLexicon',
    'SpObjectToken', 'SPPHRASEPROPERTY', 'SAFTADPCM_44kHzStereo',
    'SPEI_VOICE_CHANGE', 'DISPID_SLGenerationId',
    'DISPID_SpeechPhraseProperty', 'ISpeechObjectTokenCategory',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SGRsCommit',
    'SpeechVisemeFeature', 'SVEPrivate', 'DISPID_SPRules_NewEnum',
    'DISPID_SMSADeviceId', 'SRSEIsSpeaking', 'eLEXTYPE_PRIVATE15',
    'SAFTGSM610_44kHzMono', 'SVP_16', 'SPINTERFERENCE_TOOQUIET',
    'SDA_Consume_Leading_Spaces', 'SpAudioFormat',
    'DISPID_SPAs_NewEnum', 'eLEXTYPE_PRIVATE17', 'SPPS_Verb',
    'SRSActive', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechAudioFormat', 'SVSFNLPMask', 'DISPID_SLWsCount',
    'DISPID_SGRSTPropertyName', 'SWPUnknownWordUnpronounceable',
    'ISpeechPhraseReplacement', 'DISPID_SPRFirstElement',
    'ISpeechRecoResultDispatch', 'ISpProperties',
    'DISPID_SRCEPhraseStart', 'DISPID_SRRGetXMLErrorInfo',
    'Speech_StreamPos_Asap', 'SPCS_DISABLED', 'eLEXTYPE_PRIVATE10',
    'DISPID_SPEDisplayText', 'DISPID_SGRSTNextState',
    'DISPID_SPRNumberOfElements', 'SP_VISEME_12',
    'ISpeechResourceLoader', 'ISpeechRecoResult2',
    'DISPID_SOTCreateInstance', 'DISPID_SGRSTText',
    'ISpeechPhraseRules', 'DISPID_SVAudioOutputStream',
    'SPEI_FALSE_RECOGNITION', 'ISpStreamFormatConverter',
    'DISPID_SpeechBaseStream', 'DISPID_SRStatus',
    'SPRST_INACTIVE_WITH_PURGE', 'SVP_15', 'DISPID_SAEventHandle',
    'SPDKL_CurrentUser', 'DISPID_SPIReplacements', 'SRADynamic',
    'DISPID_SPEActualConfidence', 'SAFTADPCM_8kHzMono',
    'SAFT22kHz16BitMono', 'SECFIgnoreKanaType', 'ISpRecognizer3',
    'SPFILEMODE', 'SAFTADPCM_22kHzMono', 'SREStreamEnd',
    'SRATopLevel', 'SPEI_VISEME', 'SVP_20', 'ISpeechRecoGrammar',
    'SVP_9', 'SVP_13', 'SPEI_MIN_SR', 'eLEXTYPE_PRIVATE7',
    'DISPID_SpeechPhraseInfo', 'SDTReplacement', 'SpeechAudioVolume',
    'DISPID_SRCERecognition', 'SLOStatic', 'SpeechTokenContext',
    'SPSHORTCUTTYPE', 'SP_VISEME_4', 'SPEI_RESERVED3',
    'SPINTERFERENCE_TOOFAST', 'SpeechCategoryRecoProfiles',
    'DISPID_SPELexicalForm', 'SWPKnownWordPronounceable',
    'SPEI_UNDEFINED', 'DISPID_SVSyncronousSpeakTimeout',
    'SAFT16kHz16BitStereo', 'DISPID_SASCurrentSeekPosition',
    'SECLowConfidence', 'DISPID_SGRAddState', 'SAFT44kHz8BitMono',
    'eLEXTYPE_PRIVATE19', 'SpMMAudioEnum', 'DISPID_SPPValue',
    'ISpeechGrammarRules', 'SPSHORTCUTPAIR',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPRuleConfidence',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SpeechRecoResult',
    'SpCustomStream', 'SPVOICESTATUS',
    'DISPID_SPRuleEngineConfidence', 'SVPNormal', 'DISPID_SGRSTRule',
    'DISPID_SPAsCount', 'DISPID_SPEAudioSizeTime', 'SVP_17',
    'DISPID_SPIGrammarId', 'DISPID_SGRsItem',
    'SpeechDisplayAttributes', 'DISPID_SMSAMMHandle',
    'SPEI_PHRASE_START', 'DISPID_SREmulateRecognition',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPRulesItem',
    'DISPID_SRGState', 'DISPID_SVSpeakCompleteEvent',
    'SPEI_SR_AUDIO_LEVEL', 'SPAR_Medium', 'DISPID_SGRSRule',
    'SAFT11kHz16BitMono', 'ISpeechPhoneConverter',
    'DISPID_SpeechMMSysAudio', 'DISPID_SFSClose',
    'SpeechGrammarTagUnlimitedDictation', 'eLEXTYPE_PRIVATE9',
    'SREPropertyNumChange', 'ISpeechRecoContext', 'SPDATAKEYLOCATION',
    'ISpAudio', 'DISPID_SMSGetData', 'SPPS_Unknown', 'SPRS_INACTIVE',
    'DISPID_SPPsCount', 'DISPID_SRRSetTextFeedback',
    'SAFT48kHz16BitStereo', 'SPRST_ACTIVE', 'SPEI_START_INPUT_STREAM',
    '_ISpeechVoiceEvents', 'SPBO_PAUSE', 'ISpPhraseAlt',
    'eLEXTYPE_PRIVATE5', 'SRERequestUI', 'SAFT32kHz8BitStereo',
    'DISPID_SOTGetStorageFileName', 'DISPID_SRRTTickCount',
    'Speech_StreamPos_RealTime', 'DISPID_SPRuleParent', 'SPFM_CREATE',
    'SpeechCategoryVoices', 'DISPID_SVSInputWordLength',
    '__MIDL_IWinTypes_0009', 'eLEXTYPE_APP', 'SGRSTTRule',
    'SpStreamFormatConverter', 'ISpPhoneConverter', 'SPINTERFERENCE',
    'DISPID_SRGetRecognizers', 'SPWORDPRONOUNCEABLE',
    'SpeechPropertyComplexResponseSpeed', 'SGRSTTTextBuffer',
    'SAFTExtendedAudioFormat', 'DISPID_SPIAudioStreamPosition',
    'SREFalseRecognition', 'SVP_8', 'IInternetSecurityMgrSite',
    'DISPID_SVVoice', 'SVP_3', 'DISPID_SVEStreamEnd',
    'ISpeechPhraseElement', 'DISPID_SGRId', 'SPSHT_NotOverriden',
    'SpeechPartOfSpeech', 'SPEI_SR_PRIVATE', 'SPRULESTATE',
    'DISPID_SRCEAdaptation', 'ISpeechPhraseElements',
    'SDA_Two_Trailing_Spaces', 'DISPID_SLPs_NewEnum', 'SP_VISEME_6',
    'DISPID_SpeechRecoContext', 'SSTTWildcard',
    'DISPID_SpeechGrammarRuleState', 'DISPIDSPTSI_SelectionOffset',
    'ISpeechLexicon',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpeechObjectToken', 'SpeechSpecialTransitionType', 'SGLexical',
    'SECHighConfidence', 'DISPID_SRGRules',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRIsShared',
    'SAFTNonStandardFormat', 'SPAS_RUN', 'SPCT_SUB_COMMAND',
    'SpeechWordType', 'SRERecognition', 'SREHypothesis',
    'SpObjectTokenCategory', 'SpeechGrammarState',
    'eLEXTYPE_RESERVED8', 'SpeechVoicePriority', 'SPEI_MAX_TTS',
    'SPEI_SR_RETAINEDAUDIO', 'SWPUnknownWordPronounceable',
    'DISPID_SLGetPronunciations', 'DISPID_SRSAudioStatus',
    'SPRS_ACTIVE', 'DISPID_SRCBookmark', 'DISPID_SPCPhoneToId',
    'SAFTADPCM_8kHzStereo', 'SPVISEMES', 'DISPID_SVDisplayUI',
    'ISpeechRecoResult', 'SVEPhoneme', 'DISPID_SASFreeBufferSpace',
    'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpeechPropertyLowConfidenceThreshold',
    'ISpeechPhraseInfoBuilder', 'SpMemoryStream', 'DISPIDSPTSI',
    'SPPS_SuppressWord', 'SSFMOpenForRead',
    'DISPID_SWFEBitsPerSample', 'eLEXTYPE_PRIVATE14',
    'DISPID_SVSVisemeId', 'DISPID_SPPId', 'SINoise',
    'DISPID_SDKGetStringValue', 'SAFTGSM610_22kHzMono', 'SECFDefault',
    'SVP_7', 'DISPID_SRGCmdLoadFromMemory', 'Speech_Max_Pron_Length',
    'DISPID_SGRName', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SGRAddResource', 'DISPID_SpeechCustomStream',
    'SPPHRASERULE', 'SWTDeleted', 'STCInprocServer',
    'DISPID_SOTMatchesAttributes', 'SAFT12kHz8BitStereo',
    'STSF_LocalAppData', 'SREPrivate',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPRsItem', 'SBONone',
    'SGPronounciation', 'SDTLexicalForm',
    'ISpeechTextSelectionInformation', 'eLEXTYPE_MORPHOLOGY',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEI_PHONEME',
    'SVEWordBoundary', 'DISPID_SVSpeak', 'STCRemoteServer',
    'DISPID_SPPParent', 'SPRULE', 'DISPID_SpeechPhraseElement',
    'ISpObjectToken', 'SPBO_NONE', 'ISpeechFileStream',
    'DISPID_SPERequiredConfidence', 'SPLO_DYNAMIC',
    'SAFT22kHz16BitStereo', 'DISPID_SPIProperties',
    'eLEXTYPE_PRIVATE2', 'SASPause', 'SAFT8kHz16BitMono',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SWFEExtraData',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPDKL_LocalMachine',
    'SPAUDIOSTATUS', 'SINoSignal', 'SSFMOpenReadWrite',
    'SAFT48kHz8BitMono', 'DISPID_SVSLastBookmark',
    'SGDSActiveWithAutoPause', 'SpPhraseInfoBuilder', 'SPWORD',
    'DISPID_SLWsItem', 'DISPID_SpeechVoiceEvent',
    'SpeechAudioFormatGUIDText', 'SPPS_Function',
    'DISPID_SRRAudioFormat', 'DISPID_SAStatus', 'eLEXTYPE_USER',
    'DISPID_SBSWrite', 'DISPID_SPPEngineConfidence',
    'ISpeechLexiconPronunciation', 'DISPID_SpeechObjectToken',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRGCmdLoadFromObject',
    'SpSharedRecoContext', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SpeechAudio', 'DISPID_SRRPhraseInfo', 'SpeechAllElements',
    'DISPID_SRGDictationLoad', 'SpeechEmulationCompareFlags',
    'eLEXTYPE_PRIVATE3', 'DISPID_SABIBufferSize', 'SSTTDictation',
    'SAFT22kHz8BitStereo', 'SPSNoun', 'SpeechWordPronounceable',
    'SpeechStreamSeekPositionType', 'SDTDisplayText',
    'DISPID_SGRSAddWordTransition', 'DISPID_SLWType',
    'DISPID_SpeechDataKey', 'eWORDTYPE_ADDED', 'ISpeechMMSysAudio',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPAUDIOOPTIONS', 'SECFIgnoreWidth',
    'DISPID_SPPNumberOfElements', 'SAFTCCITT_uLaw_44kHzMono',
    'SVSFPersistXML', 'SAFTCCITT_uLaw_22kHzMono', 'ISpRecognizer',
    'DISPID_SLWs_NewEnum', 'DISPID_SVGetAudioInputs',
    'eLEXTYPE_PRIVATE13', 'DISPID_SOTRemoveStorageFileName',
    'SDKLLocalMachine', 'SAFTADPCM_22kHzStereo', 'DISPID_SOTDataKey',
    'DISPID_SpeechRecognizer', 'DISPID_SOTGetAttribute',
    'SAFTCCITT_uLaw_11kHzStereo', 'SDA_One_Trailing_Space',
    'eLEXTYPE_PRIVATE1', 'SVPAlert', 'SAFT48kHz16BitMono',
    'SPSHT_OTHER', 'ISpVoice', 'SGSExclusive', 'DISPID_SLGetWords',
    'SECFNoSpecialChars', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFT16kHz16BitMono', 'SpeechRegistryLocalMachineRoot',
    'SPSHORTCUTPAIRLIST', 'SRSEDone', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRRecognizer',
    'SVP_5', 'SPEI_HYPOTHESIS', 'SpeechRuleAttributes',
    'DISPID_SpeechPhraseRules', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SABufferInfo', 'SPXRO_Alternates_SML', 'SVP_18',
    'DISPID_SRCState', 'DISPID_SOTGetDescription',
    'DISPID_SPIEngineId', 'ISpRecoGrammar', 'SPPHRASEELEMENT',
    'DISPID_SRCRetainedAudioFormat', 'SPSTREAMFORMATTYPE',
    'SpTextSelectionInformation', 'SRTStandard', 'SPWORDLIST',
    'ISpeechGrammarRuleState', 'SPFM_NUM_MODES', 'eLEXTYPE_PRIVATE8',
    'LONG_PTR', 'SPBO_AHEAD', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SDKGetlongValue', 'SPSUnknown', 'DISPID_SLPPartOfSpeech',
    'ISpeechLexiconPronunciations', 'DISPID_SVSpeakStream',
    'SPRECORESULTTIMES', 'ISpeechCustomStream',
    'DISPID_SRCreateRecoContext', 'SGSDisabled',
    ...
    'Speech_Max_Word_Length', 'ISpeechAudioStatus', 'SPGS_EXCLUSIVE',
    'SpShortcut', 'SPFM_OPEN_READONLY',
    'DISPID_SpeechGrammarRuleStateTransition', 'SP_VISEME_16',
    'SpeechRecognitionType', 'IEnumString',
    'DISPID_SpeechRecoResult2', 'DISPIDSPTSI_ActiveLength',
    'ISpeechVoiceStatus', 'SpResourceManager',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SLWPronunciations', 'SPCONTEXTSTATE',
    'DISPID_SpeechFileStream', 'SASRun', 'eLEXTYPE_RESERVED7',
    'SPPS_Noun', 'DISPID_SPRsCount',
    'DISPID_SpeechPhraseReplacements',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPBO_TIME_UNITS',
    'DISPID_SPRs_NewEnum', 'SpeechPropertyHighConfidenceThreshold',
    'SpeechPropertyResponseSpeed', 'SpeechInterference',
    'SAFT12kHz16BitStereo', 'SAFTNoAssignedFormat', 'ISpStreamFormat',
    'SPPS_RESERVED1', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRGetPropertyNumber', 'ISpeechLexiconWords',
    'DISPID_SGRs_NewEnum', 'SPEI_SOUND_END',
    'ISpeechPhraseAlternates', 'DISPID_SRSCurrentStreamNumber',
    'SPSInterjection', 'SVEViseme', 'SPSNotOverriden',
    'SpeechGrammarTagDictation', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SLPsCount', 'DISPID_SRRTStreamTime',
    ...
    'DISPID_SRCResume', 'STCLocalServer', 'DISPID_SpeechObjectTokens',
    'SDTPronunciation', 'SGSEnabled', 'eLEXTYPE_PRIVATE12',
    'SITooFast', 'ISpDataKey', 'SSFMCreateForWrite',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpUnCompressedLexicon',
    'SREInterference', '_SPAUDIOSTATE', 'SPSModifier',
    'DISPID_SRCEStartStream', 'STCAll', 'DISPID_SRSetPropertyNumber',
    'SVEBookmark', 'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SPAsItem',
    'SPGRAMMARSTATE', 'eLEXTYPE_PRIVATE4',
    'DISPID_SpeechGrammarRules', 'DISPID_SPAStartElementInResult',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SDKOpenKey',
    'ISpeechDataKey', 'DISPID_SRRRecoContext',
    'DISPID_SDKSetLongValue', 'DISPID_SDKSetStringValue',
    'DISPID_SGRClear', 'SVEAllEvents', 'SVEVoiceChange',
    'SPWT_DISPLAY', 'SPBINARYGRAMMAR', 'ISpeechPhraseProperties',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRGDictationSetState',
    'SPDKL_CurrentConfig', 'DISPID_SBSFormat', 'SRAONone',
    'SP_VISEME_17', 'ISpRecoResult', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SLPPhoneIds',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPEVENTENUM',
    'SRSInactive', 'DISPID_SPEsItem', 'DISPID_SDKCreateKey',
    'SVSFParseAutodetect', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SASNonBlockingIO', 'DISPID_SGRSAddSpecialTransition',
    'SPEI_RESERVED2', 'eLEXTYPE_PRIVATE6', 'ISpRecognizer2',
    'DISPID_SPERetainedStreamOffset', 'SPLO_STATIC',
    'SpeechRegistryUserRoot', 'DISPID_SPERetainedSizeBytes',
    'ISpeechAudio', 'SAFT24kHz8BitMono', 'DISPID_SpeechVoiceStatus',
    'DISPID_SVESentenceBoundary', 'SVP_4', 'DISPID_SPIElements',
    'SVSFlagsAsync', 'SAFT48kHz8BitStereo', 'SAFT22kHz8BitMono',
    'SRTExtendableParse', 'SAFTADPCM_44kHzMono', 'SP_VISEME_14',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRGSetTextSelection',
    'SREAdaptation', 'SpeechTokenShellFolder', 'SLTApp', 'SPSLMA',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpPhoneticAlphabetSelection',
    'DISPID_SRAudioInput', 'SPAR_High', 'SPWAVEFORMATTYPE',
    'SPVPRI_NORMAL', 'SVP_0', 'SAFT24kHz8BitStereo',
    'DISPID_SASetState', 'DISPID_SLPType', 'SAFTADPCM_11kHzMono',
    'ISpNotifySource', 'DISPID_SASState', 'SPWORDPRONUNCIATION',
    'ISpeechRecoResultTimes', 'DISPID_SVAudioOutput',
    'SPRECOCONTEXTSTATUS', 'ISpEventSink', 'SPSSuppressWord',
    'ISpMMSysAudio', 'SPAO_NONE', 'SpNullPhoneConverter',
    'SpeechRunState', 'SpeechCategoryAppLexicons', 'ISpNotifySink',
    'DISPID_SRRDiscardResultInfo', 'SPSVerb', 'DISPID_SVVolume',
    'DISPID_SLWLangId', 'DISPID_SDKSetBinaryValue', 'SITooQuiet',
    'DISPID_SRRAudio'
]

_check_version('1.1.14', 1652216979.197195)
